...
def main(argv=sys.argv):
    ...
    #for i in range(106, num_data):
        ...
        context = contexts[i]
        statement = [np.concatenate((context[i]), axis=None) for i in range(len(context))]
        ...
        for entity in entities:
            ...
            while start >= statement_index[statement_iter] + sentence_index[statement_iter][sentence_iter+1]:
                sentence_iter += 1
                 
            start -= (statement_index[statement_iter] + sentence_index[statement_iter][sentence_iter])
            end -= (statement_index[statement_iter] + sentence_index[statement_iter][sentence_iter])
